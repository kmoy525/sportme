...
export const metadata = { title: "Set up your profile · TrainWithMe" };
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-chalk">
      <header className="bg-turf px-5 py-6">
        <div className="mx-auto flex max-w-md items-center gap-2 text-chalk">
      ...
      <main className="mx-auto w-full max-w-md flex-1 px-5 py-8">
        <h1 className="display text-3xl text-turf">Set up your profile</h1>
