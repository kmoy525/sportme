...
export const metadata = { title: "Terms of Service · TrainWithMe" };
...
export default function TermsPage() {
  return (
    <article className="space-y-4 text-sm leading-relaxed text-ink/80">
      <h1 className="display text-3xl text-turf">Terms of Service</h1>

      <p className="rounded-md border border-scoreboard/50 bg-scoreboard/15 px-3 py-2 text-xs font-semibold text-ink">
        Placeholder text — replace before launch.
      </p>

      <h2 className="display pt-2 text-lg text-turf">Who can use TrainWithMe</h2>
      <p>
      ...
      <h2 className="display pt-2 text-lg text-turf">How you treat other members</h2>
      <p>
        TrainWithMe exists to connect training partners. Harassment, misrepresenting who
        you are, and inappropriate photos are not allowed. You can report or block any
        member from anywhere their profile appears.
      </p>

      <h2 className="display pt-2 text-lg text-turf">Training is at your own risk</h2>
      <p>
      ...
      <h2 className="display pt-2 text-lg text-turf">Events</h2>
      <p>
